...
BuildWithXbuild()
{
    ...
    CheckExitCode dotnet msbuild /t:Clean $slnFile
    mono $nuget restore $slnFile
    CheckExitCode dotnet msbuild /p:Configuration=Release /p:Platform=x86 /t:Build /p:AllowedReferenceRelatedFileExtensions=.pdb $slnFile
}
